...
#accelImmersionDF = pd.read_csv("./z leg rings/Tag60826/Obs020925_125338_Tag60826AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
#accelImmersionDF = pd.read_csv("./z leg rings/Tag60829/Obs020925_105116_Tag60829AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
...
#accelImmersionDF = pd.read_csv("./z leg rings/Tag60833/Obs020925_105954_Tag60833AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
...
#accelImmersionDF = pd.read_csv("./z leg rings/Tag60983/Obs020925_115202_Tag60983AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
...
#accelImmersionDF = pd.read_csv("./z leg rings/Tag61059/Obs020925_114224_Tag61059AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
...
#accelImmersionDF = pd.read_csv("./z leg rings/Tag61082/Obs010925_160420_Tag61082AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
...
#accelImmersionDF = pd.read_csv("./z leg rings/Tag61139/Obs010925_162541_Tag61139AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
#accelImmersionDF = pd.read_csv("./z leg rings/Tag61148/Obs020925_090746_Tag61148AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
#accelImmersionDF = pd.read_csv("./z leg rings/Tag61159/Obs020925_093837_Tag61159AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)
#accelImmersionDF = pd.read_csv("./z leg rings/Tag61160/Obs020925_095252_Tag61160AccWetDry.txt",sep=' ',names=["year","month","day","hour","minute","second","X","Y","Z","mag","immersed"],header=None,skiprows=5)

accelImmersionDF["datetime"] = pd.to_datetime(accelImmersionDF[["year","month","day","hour","minute","second"]])

accelImmersionDF = accelImmersionDF[accelImmersionDF.year > 2000]
...
#gpsDF = pd.read_csv("./z leg rings/Tag60826/Obs020925_125338_Tag60826.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
#gpsDF = pd.read_csv("./z leg rings/Tag60829/Obs020925_105116_Tag60829.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
...
#gpsDF = pd.read_csv("./z leg rings/Tag60833/Obs020925_105954_Tag60833.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
...
#gpsDF = pd.read_csv("./z leg rings/Tag60983/Obs020925_115202_Tag60983.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
...
#gpsDF = pd.read_csv("./z leg rings/Tag61059/Obs020925_114224_Tag61059.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
...
#gpsDF = pd.read_csv("./z leg rings/Tag61082/Obs010925_160420_Tag61082.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
...
#gpsDF = pd.read_csv("./z leg rings/Tag61139/Obs010925_162541_Tag61139.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
#gpsDF = pd.read_csv("./z leg rings/Tag61148/Obs020925_090746_Tag61148.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
#gpsDF = pd.read_csv("./z leg rings/Tag61159/Obs020925_093837_Tag61159.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)
#gpsDF = pd.read_csv("./z leg rings/Tag61160/Obs020925_095252_Tag61160.raw",sep=' ', names=["year","day","second","vbatt","TTF","numSVs"], usecols=[0,1,2,3,4,5], header=None, skiprows=5)

gpsDF["datetime"] = gpsDF.apply(lambda x: convertDatetime(x), axis=1)

gpsDF = gpsDF[gpsDF.year > 2000]
